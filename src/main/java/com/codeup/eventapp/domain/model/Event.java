...
/**
 * Domain model for Event (pure business logic, framework-independent)
 */
public class Event {
    private Long id;
    private String name;
    ...
    public Event(String name, String location, LocalDateTime date, String description, Venue venue) {
        this(null, name, location, date, description, venue);
    }
